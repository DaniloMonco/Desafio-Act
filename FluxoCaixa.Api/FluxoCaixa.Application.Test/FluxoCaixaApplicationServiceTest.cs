...
{
    public class FluxoCaixaApplicationServiceTest
    {
        ...
        public FluxoCaixaApplicationServiceTest()
        {
        ...
        private Domain.Model.FluxoCaixa FluxoCaixaDiarioMock()
        {
            ...
            {
                new Lancamento(Guid.NewGuid(), dataHora, 10, "Debito 1", TipoLancamento.D),
                new Lancamento(Guid.NewGuid(), dataHora, 20, "Debito 2", TipoLancamento.D),
                new Lancamento(Guid.NewGuid(), dataHora, 20, "Credito 1", TipoLancamento.C),
            };
